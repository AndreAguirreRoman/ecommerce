            ...
            <form onSubmit={handleSubmit} className={`${className} review-form`}>
                ...
                <div className='review-form__details review-details'>
                    ...
                    <div className='review-details__subtotal review-detail'>
                        ...
                        <div className='review-detail__price'>${(subtotal * tax - subtotal).toFixed(2)}</div>
                    </div>
                    ...
                    <div className='review-details__total review-detail-green review-detail'>
                        <div className='review-detail-green__title review-detail__title'>Total</div>
                        <div className='review-detail-green__price review-detail__price'>${(subtotal * tax).toFixed(2)}</div>
                    </div>
                </div>
